...
describe('GameLaunchService', () => {
  ...
  describe('getDemoLaunchUrl', () => {
    it('returns the correct fallback demo URLs for all providers', () => {
      const service = new GameLaunchService(
        {} as any,
        {} as any,
        {} as any,
      ...
      expect(getDemoLaunchUrl('vs5jokerdice', 'pragmatic')).toBe('https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs5jokerdice&lang=en&cur=USD');
    });
  });
});
